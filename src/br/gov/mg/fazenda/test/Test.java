...
public class Test extends AbstractController {
	public static void main(String[] args) {
		...
		for (SweepstakeEntity sweepstake : sweepstakes) {
			...
			System.out.println("dtPrevSorteio: " + sweepstake.dtPrevSorteio);
		...
		/*for (PremiumEntity premium : PremiumController.findPremiums("1484", "3101")) {
			...
			System.out.println("vlrPremioEntidSocial: " + premium.vlrPremioEntidSocial);
		}*/
		
		/*ResultSocialEEntity result = SocialEntityController.findSocialEntities("", "", "", "");
